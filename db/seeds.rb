...
order_1 = Order.create!(user: buyer_1, status: 2, address_id: buyer_1_address.id)
order_2 = Order.create!(user: buyer_2, status: 2, address_id: buyer_2_address.id)
order_3 = Order.create!(user: buyer_3, status: 2, address_id: buyer_3_address.id)
order_4 = Order.create!(user: buyer_4, status: 2, address_id: buyer_4_address.id)
order_5 = Order.create!(user: buyer_5, status: 2, address_id: buyer_5_address.id)
order_6 = Order.create!(user: buyer_1, status: 2, address_id: buyer_1_address.id)
order_7 = Order.create!(user: buyer_2, status: 2, address_id: buyer_2_address.id)
