...
order_1 = Order.create!(user: buyer_1, status: 0, address_id: buyer_1_address)
order_2 = Order.create!(user: buyer_2, status: 1, created_at: 3.days.ago, updated_at: 1.days.ago, address_id: buyer_2_address)
order_3 = Order.create!(user: buyer_3, status: 0, address_id: buyer_3_address)
order_4 = Order.create!(user: buyer_4, status: 2, created_at: 9.days.ago, updated_at: 1.days.ago, address_id: buyer_4_address)
order_5 = Order.create!(user: buyer_5, status: 0, address_id: buyer_5_address)
order_6 = Order.create!(user: buyer_1, status: 2, created_at: 5.days.ago, updated_at: 1.days.ago, address_id: buyer_1_address)
order_7 = Order.create!(user: buyer_2, status: 3, created_at: 9.days.ago, updated_at: 1.days.ago, address_id: buyer_2_address)
order_8 = Order.create!(user: buyer_3, status: 0, address_id: buyer_3_address)
order_9 = Order.create!(user: buyer_4, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago, address_id: buyer_4_address)
order_10 = Order.create!(user: buyer_5, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago, address_id: buyer_5_address)
order_11 = Order.create!(user: buyer_1, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago, address_id: buyer_1_address)
order_12 = Order.create!(user: buyer_2, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago, address_id: buyer_2_address)
order_13 = Order.create!(user: buyer_3, status: 2, created_at: 2.days.ago, updated_at: 1.days.ago, address_id: buyer_3_address)
order_14 = Order.create!(user: buyer_4, status: 2, created_at: 6.days.ago, updated_at: 1.days.ago, address_id: buyer_4_address)
order_15 = Order.create!(user: buyer_5, status: 2, created_at: 3.days.ago, updated_at: 1.days.ago, address_id: buyer_5_address)
order_16 = Order.create!(user: buyer_3, status: 2, created_at: 9.days.ago, updated_at: 1.days.ago, address_id: buyer_3_address)
order_17 = Order.create!(user: buyer_3, status: 2, created_at: 6.days.ago, updated_at: 1.days.ago, address_id: buyer_3_address)
order_18 = Order.create!(user: buyer_3, status: 2, created_at: 4.days.ago, updated_at: 1.days.ago, address_id: buyer_3_address)
order_19 = Order.create!(user: buyer_2, status: 2, created_at: 7.days.ago, updated_at: 1.days.ago, address_id: buyer_2_address)
order_20 = Order.create!(user: buyer_2, status: 2, created_at: 3.days.ago, updated_at: 1.days.ago, address_id: buyer_2_address)
