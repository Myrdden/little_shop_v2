...
RSpec.describe Item, type: :model do
  before :each do
    ...
    @user_3 = User.create!(email: "user_3@gmail.com", role: 2, name: "User 3", password: "123456")
    @user_3_address = @user_3.addresses.create!(name: "Home", address: "User 3 Address", city: "User 3 City", state: "User 3 State",zip:"32345")
    @user_4 = User.create!(email: "user_4@gmail.com", role: 2, name: "User 4", password: "123456")
    @user_4_address = @user_4.addresses.create!(name: "Home", address: "User 4 Address", city: "User 4 City", state: "User 4 State",zip:"42345")
    @user_5 = User.create!(email: "user_5@gmail.com", role: 0, name: "User 5", password: "123456")
    @user_5_address = @user_5.addresses.create!(name: "Home", address: "User 5 Address", city: "User 5 City", state: "User 5 State",zip:"52345")
    @user_6 = User.create!(email: "user_6@gmail.com", role: 0, name: "User 6", password: "123456")
    @user_6_address = @user_6.addresses.create!(name: "Home", address: "User 6 Address", city: "User 6 City", state: "User 6 State",zip:"62345")
    @user_7 = User.create!(email: "user_7@gmail.com", role: 0, name: "User 7", password: "123456")
    @user_7_address = @user_7.addresses.create!(name: "Home", address: "User 7 Address", city: "User 7 City", state: "User 7 State",zip:"72345")
    ...
    @order_1 = @user_5.orders.create!(status: 3, address_id: @user_5_address.id)
    @order_2 = @user_5.orders.create!(status: 3, address_id: @user_5_address.id)
    @order_3 = @user_6.orders.create!(status: 3, address_id: @user_6_address.id)
    @order_4 = @user_6.orders.create!(status: 3, address_id: @user_6_address.id)
    @order_5 = @user_7.orders.create!(status: 3, address_id: @user_7_address.id)
    @order_6 = @user_7.orders.create!(status: 3, address_id: @user_7_address.id)
    @order_7 = @user_8.orders.create!(status: 3, address_id: @user_8_address.id)
    @order_8 = @user_8.orders.create!(status: 3, address_id: @user_8_address.id)
