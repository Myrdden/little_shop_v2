...
RSpec.describe User, type: :model do
  ...
  describe "class methods" do
    before :each do
      ...
      @user_1_address = @user_1.addresses.create(:address_bot, city: "Denver", state: "CO")
      @user_2 = create(:user, name: "Adam")
      @user_2_address = @user_2.addresses.create(:address_bot)
      @user_3 = create(:merchant)
      @user_3_address = @user_2.addresses.create(:address_bot, city: "Sacramento", state: "CA")
      @user_4 = create(:merchant)
      @user_4_address = @user_2.addresses.create(:address_bot, city: "Springfield", state: "CO")
      @user_5 = create(:user, name: "Carly")
      @user_5_address = @user_2.addresses.create(:address_bot)
      @user_6 = create(:merchant)
      @user_6_address = @user_2.addresses.create(:address_bot, city: "Springfield", state: "NY")
      @user_7 = create(:user, name: "Daniel")
      @user_7_address = @user_2.addresses.create(:address_bot)
      @user_8 = create(:user, name: "Gerald")
      @user_8_address = @user_2.addresses.create(:address_bot, city: "Cheyenne", state: "WY")
      @user_9 = create(:user, name: "Tommy")
      @user_9_address = @user_2.addresses.create(:address_bot, city: "Billings", state: "MT")
      @user_10 = create(:user, name: "Yolanda")
      @user_10_address = @user_2.addresses.create(:address_bot, city: "Boise", state: "ID")
      @users = User.all
      ...
      @order_1 = create(:packaged, user: @user_2, address_id: @user_2_address.id)
      @order_2 = create(:packaged, user: @user_7, address_id: @user_7_address.id)
      @order_3 = create(:packaged, user: @user_8, address_id: @user_8_address.id)
      @order_4 = create(:packaged, user: @user_9, address_id: @user_9_address.id)
      @order_5 = create(:packaged, user: @user_9, address_id: @user_9_address.id)
      @order_6 = create(:packaged, user: @user_9, address_id: @user_9_address.id)
      @order_7 = create(:packaged, user: @user_9, address_id: @user_9_address.id)
      @order_8 = create(:packaged, user: @user_9, address_id: @user_9_address.id)
      @order_9 = create(:packaged, user: @user_10, address_id: @user_10_address.id)
  ...
  describe "instance methods" do
    before :each do
      @merchant_1 = User.create!(email: "merchant_1@gmail.com", role: 1, name: "Merchant 1", password: "123456")
      @merchant_2 = User.create!(email: "merchant_2@gmail.com", role: 1, name: "Merchant 2", password: "123456")
      @user_1= User.create!(email: "user_1@gmail.com", role: 0, name: "User 1", password: "123456")
      @user_1_address = @user_1.addresses.create!(name: "home", address: "user 1 address", city: "user 1 city", state: "user 1 state", zip:"52345")
      @user_2 = User.create!(email: "user_2@gmail.com", role: 0, name: "User 2", password: "123456")
      @user_2_address = @user_2.addresses.create!(name: "home", address: "user 2 address", city: "user 2 city", state: "user 2 state", zip:"62345")
      @user_3 = User.create!(email: "user_3@gmail.com", role: 0, name: "User 3", password: "123456")
      @user_3_address = @user_3.addresses.create!(name: "Home", address: "User 3 Address", city: "User 3 City", state: "User 3 State", zip:"72345")
      @user_4 = User.create!(email: "user_4@gmail.com", role: 0, name: "User 4", password: "123456")
      @user_4_address = @user_4.addresses.create!(name: "Home", address: "User 4 Address", city: "User 4 City", state: "User 4 State", zip:"82345")
      ...
      @order_1 = @user_1.orders.create!(status: 2, address_id: @user_1_address.id)
      @order_2 = @user_1.orders.create!(status: 2, address_id: @user_1_address.id)
      @order_3 = @user_2.orders.create!(status: 2, address_id: @user_2_address.id)
      @order_4 = @user_2.orders.create!(status: 2, address_id: @user_2_address.id)
      @order_5 = @user_3.orders.create!(status: 2, address_id: @user_3_address.id)
      @order_6 = @user_3.orders.create!(status: 2, address_id: @user_3_address.id)
      @order_7 = @user_4.orders.create!(status: 3, address_id: @user_4_address.id)
      @order_8 = @user_4.orders.create!(status: 0, address_id: @user_4_address.id)
